...
class HomeScreen extends ConsumerWidget {
  ...
  bool _isUpdateCalled = false; // Flag to track if updateAll is called
  ...
  if (_user != null && _user.uid.isNotEmpty && !_isUpdateCalled) {
    String _name = _user!.displayName ?? '';
    String _photoURL = _user.photoURL ?? '';
    String _playerId = _user.uid ?? '';

    /*WidgetsBinding.instance.addPostFrameCallback((_) {
        ref.read(playerProvider.notifier).updateAll(_playerId, _photoURL, _name);
    });*/
  }
